...
var Module = {
	...
	UE4_indexedDBVersion: 202404151848, // Bump this number to invalidate existing IDB storages in browsers.
};
...
$(document).ready(function() {
	...
	function withIndexedDB(db) {
		...
		var mainCompiledCode = fetchFromIndexedDB(db, 'wasmModule').then(function(wasmModule) {
			...
			return download(Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/4mm58s62zi15z253bzgke/MyProject3-HTML5-Shipping.wasm?rlkey=7x43cr67joodwv70dlou9xca0&dl=0'), 'arraybuffer').then(function(wasmBytes) {
		...
		// ----------------------------------------
		// MORE JS
		var dataJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/grahorica/testtilda/f347d283f2c2cf4935aadc5d6ed1a04caec2cdf2/MyProject3-HTML5-Shipping.data.js'));
		var utilityJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/grahorica/testtilda/fb9af706372d98f25a2ddb91d6fb7b63e8812450/Utility.js')).then(addScriptToDom);
		var dataDownload =
...
// Instead as a fallback, download as ArrayBuffer. (TODO: Figure out the bugs with the above, and switch to using that one instead)
			fetchOrDownloadAndStore(db, Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/z58mz3fq90ycpqueucfyc/MyProject3-HTML5-Shipping.data?rlkey=cocme1edaiez6wctv1fa74317&dl=0'), 'arraybuffer').then(function(dataArrayBuffer) {
				Module['preloadedPackages'] = {};
				Module['preloadedPackages'][Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/z58mz3fq90ycpqueucfyc/MyProject3-HTML5-Shipping.data?rlkey=cocme1edaiez6wctv1fa74317&dl=0')] = dataArrayBuffer;
				return dataJsDownload.then(addScriptToDom);
			});
